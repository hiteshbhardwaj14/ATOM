...
% str_roll = (sum_eHead * ki_head_w_roll);       % Change direction based on heading
str_dir = (sum_eHead_dir * ki_head);        % Change direction after reaching waypoint 
...
elseif (thr_rol_mode < 0)    % Backward motion
    ...
    if ((currentRoll_off > -(pi/2)) && (currentRoll_off < (pi/2))) %0.25,2.5
